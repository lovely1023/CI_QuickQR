                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <table class="quickad-codes">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td><input value="{ORDER_TYPE}" readonly="readonly" onclick="this.select()">- Order type</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td><input value="{PHONE_NUMBER}" readonly="readonly" onclick="this.select()">- Phone Number</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td><input value="{ADDRESS}" readonly="readonly" onclick="this.select()">- Address</td>
                                                                                            </tr>
                                                                                            <tr>
